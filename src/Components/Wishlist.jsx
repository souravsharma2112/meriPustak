...
function Wishlist() {
    ...
    return (
        <>
            <Shopgrid title="Wishlist" text="Get your favorite get your best."/>
                                    ...
                                    <tbody>
                                        {
                                            cartItem.map((value, index)=>{
                                                ...
                                                return(
                                                    <>
                                                        <Wishitem bookName={bookName} bookImg = {bookImg}  price = {price}  falsePrice= {falsePrice} condition = "Cart"/>
                                                    </>
                                                )
                                            })
                                        }
